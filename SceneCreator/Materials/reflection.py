...
class Reflection:
    ...
    def change_fuze(self):
        ...
        while True:
            try:
                new_value = float(input(f"{YELLOW}Enter new fuze value (0-100): {RESET}"))
                if 0 <= new_value <= 100:
                    self.fuze = new_value
    ...
    def write(self, file):
        file.write("            # Reflection material\n")
        file.write(f"            reflection = \"{self.fuze}%\";\n")
