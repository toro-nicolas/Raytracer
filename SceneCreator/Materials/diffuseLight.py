...
class DiffuseLight:
    ...
    def change_red(self):
        ...
        while True:
            try:
                new_value = int(input(f"{YELLOW}Enter new red value (0-255): {RESET}"))
                if 0 <= new_value <= 255:
                    self.red = new_value
    ...
    def change_green(self):
        ...
        while True:
            try:
                new_value = int(input(f"{YELLOW}Enter new green value (0-255): {RESET}"))
                if 0 <= new_value <= 255:
    ...
    def write(self, file):
        file.write("            # Diffuse Light material\n")
        file.write("            diffuselight = {\n")
        file.write("                color = {\n")
